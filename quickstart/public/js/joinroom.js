 ...
 */
export function joinRoom(token, connectOptions) {
    return __awaiter(this, void 0, void 0, function* () {
        // Join to the Room with the given AccessToken and ConnectOptions.
        const room = yield connect(token, connectOptions);
        ...
        return new Promise((resolve, reject) => {
            ...
            if (isMobile) {
                ...
                document.onvisibilitychange = () => __awaiter(this, void 0, void 0, function* () {
                    if (document.visibilityState === 'hidden') {
                        ...
                        localVideoTrack = yield createLocalVideoTrack(connectOptions.video);
                        yield room.localParticipant.publishTrack(localVideoTrack);
                    }
                });
            }
