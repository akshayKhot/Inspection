...
function applyInputDevice(kind, deviceId, render) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const [track] = yield createLocalTracks({ [kind]: { deviceId } });
 ...
 */
export function selectMedia(kind, $modal, render) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let devices = yield getInputDevices(kind);
        // Apply the default media input device.
        yield applyInputDevice(kind, devices[0].deviceId, render);
        ...
        if (devices.every(({ deviceId, label }) => !deviceId || !label)) {
            devices = yield getInputDevices(kind);
        }
