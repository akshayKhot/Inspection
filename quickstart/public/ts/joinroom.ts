...
export class RoomJoiner {
  ...
  constructor() {
    ...
    this.$room = $('#room');
    this.$activeParticipant = $('div#active-participant > div.participant.main', this.$room);
    this.$activeVideo = $('video', this.$activeParticipant);
    this.$participants = $('div#participants', this.$room);
  }
 ...
 */
  setActiveParticipant(participant) {
    ...
    this.$activeParticipant.attr('data-identity', identity);
  }
  ...
  setupParticipantContainer(participant, room) {
    ...
    this.$participants.append($container);
  }
  ...
  attachTrack(track, participant) {
    ...
    const $media = $(`div#${participant.sid} > ${track.kind}`, this.$participants);
    $media.css('opacity', '');
  ...
  participantDisconnected(participant, room) {
    ...
    $(`div#${participant.sid}`, this.$participants).remove();
  }
  ...
  async joinRoom(token, connectOptions) {
    ...
    return new Promise((resolve, reject) => {
      ...
      room.once('disconnected', (room, error) => {
        ...
        const media = this.$activeVideo.get(0) as any;
